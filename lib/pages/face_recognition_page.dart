import 'package:face_recognition/view_model/face_recognition_model.dart';
...
class _FaceRecognitionPageState extends State<FaceRecognitionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Face Recognition', style: TextStyle(color: white)),
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              // InkWell(
              //   onTap: () async {
              //     String result = await viewModel.compareFaces(
              //       ImageSource.gallery,
              //     );
              //     if (context.mounted) {
              //       showDialog(
              ...
              //     }
              //   },
              //   child: const CustomButton(text: 'Compare Two Faces'),
              // ),
              const SizedBox(height: 10),
              InkWell(
                onTap: () async {
