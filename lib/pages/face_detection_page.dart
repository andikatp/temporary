...
import 'package:face_recognition/view_model/face_detection_viewmodel.dart';
import 'package:face_recognition/widget/custom_button.dart';
...
class _FaceDetectionPageState extends State<FaceDetectionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Face Detection', style: TextStyle(color: white)),
